...
from bug_lang.render import DotRender
#from rich import print
from tabulate import tabulate

#TODO: use click instead of this
...
def menu():
    print("\t\t\t\n ################################ Bug-lang ################################  \n")
    print("usage: buglang.py [-h] [-d] [-o OUT] [-l] [-a] [-D] [-p] [-I] [--sym] [-S] [-R] input\n")

    print("Compiler for Bug-lang programs\n")

    print("positional arguments:")
    print("input Bug-lang            program file to compile\n")
...
def main(argv):
    ...
    if len(argv) > 2:
        ...
        try:
            while True:
                source = input("bug > ") #This one works for very simple one line stuff, but the environments of neither Checker or Interpret work properly.
                ctxt.parse(source)
